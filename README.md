...
## Intro
This repository is not a focused on a single project. It is a collection of ideas, sources, and hopefully useful stuff mostly for developers using Apple infrastructure including server side Swift. Because of the nature of our company projects, we do not use third party software. This repository is just a collection of loosely coupled sources (classes, structs, etc.) and other resources.
